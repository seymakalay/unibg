...
Package `pomodoro` runs bagging (`BAG_Model`), boosting (`GBM_Model`), random forest (`RF_Model`), 
...
And it implements stratified random sampling to divide the data set into 
80/20 train/test set, using 10 cross validation.
