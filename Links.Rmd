...
<!--\1  
### R-Studio
[R-studio](http://www.rstudio.com) is a free open-source programming language that can be used for statistical analysis, data-simulation, graphing, application and lots of other fun stuff.

<a href="C:/Users/seyma/resume/SK.pdf" download> Download the Curriculum Vitae </a>
\1-->
...
Follow me in [linkedin](https://www.linkedin.com/in/%C5%9Feyma-kalay-3315345b/) and see my other [github repositories](https://github.com/seymakalay).

<a href="./SK&Cover.pdf" download>Download the Curriculum Vitae </a>

<!--\1   
### My Packages

[Pomodoro CRAN](https://cran.r-project.org/web/packages/pomodoro/pomodoro.pdf){target="_blank"}

\1-->

```{r }
library(Rd2md)
rdfile = "C:/Users/seyma/Docs/Kalay.Package/pomodoro/man/RF_Model.Rd"
outfile = "./md/myfun2.md"
