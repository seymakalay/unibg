...
the group measures, mentioned bellow, we can  assign the 'Time Intelligence' column name as 'Time Intelligence Type' and
set the ordinal of the measures by moving them up or down.
Lastly, let\'s check the ordinality of 'z-Time Intelligence' calculation group on the table view.
<!--\1 [link](#dimcalendar) -->
...
```
Let\'s create a measure and call it Time Since Last Refresh to inform the Power BI user as in [Figure 1](#New_Parameter). 
...
<div class="my-right-figure">
```{r echo=FALSE, fig.cap = "Figure 1", out.width='100%', fig.align='left'}
...
<body>
    <ul>
      <li>Don\'t overload your model.</li>
      <li>Don\'t use the same semantic model.</li>
      <li>Don\'t keep in the report unused DAX and tables.</li>
    </ul>
</body>

<div class="my-right-figure">
```{r echo=FALSE, fig.cap = " ", out.width='100%', fig.align='center'}
knitr::include_graphics('images/DataModeling.png')
```
</div>
...
<body>
    <ul>
      <li>Create a Power BI template where you can have the min necessary tables (dimCalander, dimCurrency, FactFX, etc.) 
      and DAX measures (Last time to Refresh, Personal Greetings Login Name, Time Intelligence, etc.).</li>
      <li>Build smaller Power BI reports.</li>
      <li>Create each time a new semantic model.</li>
      <li>Avoid using Direct Query or Lived Connection.</li>
    </ul>
</body>
...
<div class="my-right-figure">
```{r echo=FALSE, fig.cap = " ", out.width='100%', fig.align='center'}
knitr::include_graphics('images/DataModelingSimple.png')
```
</div>
...
# Greeting the User 
Let\'s create a measure to greet the Power BI user as in [Figure 1](#Viz-Ideas). 
