...
let
    ...
    "Material", "Local ERP Item", //"ABC Code", "Material Category","external material group code_XA", "external material group code_Pcode", "external material group",      "type", "Inventory Amt LC", "Inventory Qty (BUOM)",  "Fiscal Year", "Fiscal Week Num", 
    "Month", "Day",  "Curreny", "FY24 AOP", "FY25 AOP",
     "Inventory @AOP24", "Inventory @AOP25", "ERP", "Date", “"Fiscal Year - Copy"}),
