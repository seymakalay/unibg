...
# Software
**R Package** *Pomodoro:* Comparison of predictive power models. This package is intended to make
modeling and comparing the predictive powers easier based on the data-splits and all data set.\
**R Package** *Pepe:* Is intended to make descriptive statistics easier, expected release late 2022.
