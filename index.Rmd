...
```{r echo=FALSE, fig.cap = " ", out.width='100%', fig.align='right'}
knitr::include_graphics('images/logo.jpg')
```
</div>

I have a  PhD in Applied Economics and Management (AEM) at the 
...
During my PhD, I have been thankful to my seniors  
<a href="https://sites.google.com/site/danielfelixahey/home" target="_blank">Daniel Felix Ahelegbey </a> \&
<a  href= "https://oric.iba.edu.pk/profile.php?id=ashrafkhan" target="_blank"> Ashraf Khan </a>
whom I learn and improve a lot
<!--\1  Especially, I am personally thankful to  \1-->
as well as the head of the department 
...
__First Year:__ I conducted a study based on anti money laundering, using Unicredit data set.

__Second Year:__ I conducted a study based on credit risk, using CHFS data set.
...
__Fourth Year:__ I conducted  <a href="https://github.com/seymakalay/pomodoro" target="_blank">pomodoro</a> 
and <a href="https://github.com/seymakalay/pepe" target="_blank">pepe</a> CRAN packages. 
