...
* PhD in Applied Economics and Management (AEM) at 
...
__Main Area of Interest:__   

* Data Manipulations
* Interactive Data Visualization & Mapping 
* Data Storytelling 
* Implementing Machine Learning Algorithms  
* Building Interactive User Interfaces ([`r fa("github", fill = "purple")`](https://github.com/seymakalay))
